...
public class LoginActivity extends Activity {
	...
	public void login(View view) {
		...
		try {
			...
			if (HttpHelper.validateLogin(user, pass)) {
				Toast.makeText(getApplicationContext(), "Logged in as " + user + ".",
	...
	public void highscores(View view) {
		String LEADERBOARD_ID = getApplicationContext().getString(R.string.leaderboard_largest_size);
		int REQUEST_LEADERBOARD = 1010928318;
		
		//getGamesClient().submitScore(LEADERBOARD_ID, 1337);
		//startActivityForResult(getGamesClient().getLeaderboardIntent(LEADERBOARD_ID), 5001);
